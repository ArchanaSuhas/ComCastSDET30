...
public class CreateMailMergeTemplateWithOraganisationTest {
	...
	public void CreateMailMergeWithContactTest() throws Throwable
	{
		//step1: read data from property file
				...
				//step6:select module as contact
				WebElement ele = driver.findElement(By.xpath("//select[@name='target_module']"));
